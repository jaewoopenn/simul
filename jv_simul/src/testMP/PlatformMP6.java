...
public class PlatformMP6 {
	public static int idx=3;
	public static int log_level=3;
	public int isReal=0;
	private int[] g_r={520,600,680};
	
	
	public PlatformMP getCommmon(){
		PlatformMP p=new PlatformMP(8);
		p.setPath("mp");
		p.setCfg_fn("cfg/");
		if(isReal==1){
			p.setDuration(10000);
...
//		p.isWrite=false;
	...
	public static void main(String[] args) throws Exception {
		Class c = PlatformMP6.class;
		PlatformMP6 m=new PlatformMP6();
		int[] aret=PlatformMP6.gret;
		if(idx==-1)
